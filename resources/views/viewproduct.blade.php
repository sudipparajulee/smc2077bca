...
@section('content')
    ...
    <div class="px-24">
        ...
        <p class="text-gray-700">Lorem ipsum dolor sit amet consectetur adipisicing elit. Commodi hic ipsam temporibus doloribus maxime? Dicta dignissimos ducimus officia recusandae consequuntur sit animi, placeat ad excepturi aspernatur numquam similique blanditiis culpa!</p>
    </div>
@endsection
